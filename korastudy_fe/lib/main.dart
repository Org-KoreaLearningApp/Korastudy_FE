...
import 'package:korastudy_fe/pages/testpage/TestPageChoose.dart'; // Thêm import cho TestPageChoose
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/listvoca': (context) => VocabularyListMeanWidget(setId: '',),
        ...
        '/testPageChoose': (context) => TestPageChooseWidget(), // Thêm route cho TestPageChoose
      },
    );
  }
}